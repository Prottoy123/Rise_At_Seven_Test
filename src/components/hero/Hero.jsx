...
const Hero = () => {
  return (
    <section className="h-full">
      <div className="relative h-full md:rounded-[32px] overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?q=80&w=2072"
            alt=""
        ...
        {/* Content */}
        <div className="relative z-20 flex flex-col items-center justify-center min-h-screen text-center text-white lg:px-6 px-4 pt-0">
          <p className="text-sm font-black uppercase font-semibold mb-2">
            #1MOST RECOMMENDED <br />
            CONTENT MARKETING AGENCY
          </p>

          <div className="mb-5 flex items-center gap-x-2 opacity-80 scale-90 md:scale-100">
            <svg
              viewBox="0 0 28 38"
              fill="none"
            ...
            <img
              src="/public/images/we_are_search_logo.png"
              className="w-12 aspect-20/9 relative invert brightness-0 object-contain"
              alt="Award"
            />
            <img
          ...
          <h1 className="text-[60px] lg:text-[100px] xl:text-[120px] leading-[0.9] md:leading-[0.85] font-black tracking-tighter text-center font-semibold">
            We Create <br />
            <span className="flex items-center justify-center gap-2 md:gap-4 flex-wrap sm:flex-nowrap">
              Category
              <div className="flex items-center justify-center">
                <div className="w-[10vw] h-[10vw] max-w-24 max-h-24 min-w-[50px] min-h-[50px] rounded-xl md:rounded-2xl overflow-hidden border border-white/20">
                  <img
                    src="https://i.ibb.co.com/JRx4MZs7/premium-photo-1681022527718-81786d7873bd.avif"
                    className="w-full h-full object-cover"
                    alt="Visual"
                  />
                </div>
          ...
          <p className="mt-5 lg:text-[30px] md:text-[22px] text-base font-semibold text-white">
            on every searchable platform
          </p>

          {/* Logo  */}

          <div className="hidden lg:flex mt-12 flex-wrap justify-center items-center gap-4 md:gap-12 text-white opacity-80 hover:opacity-100 transition-opacity duration-700">
            {brands.map((brand) => (
              <div
                key={brand.name}
        ...
        {/* Footer */}
        <div className="absolute bottom-5 md:bottom-10 left-0 w-full lg:px-10 px-4 flex flex-col md:flex-row md:justify-between justify-center items-center lg:text-base md:text-[10px] text-sm text-white z-[50] pointer-events-none">

          <div className="hidden md:block">
            Organic media planners creating, distributing & optimising <br />
            <span className="font-semibold">search-first</span> content for SEO,
            Social, PR, Ai and LLM search
          </div>

          <div className="md:text-right text-center leading-tight">
