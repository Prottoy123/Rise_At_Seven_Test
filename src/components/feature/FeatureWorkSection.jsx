      ...
      <div className=" w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-8">
            <button className="bg-black text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-[#b2f9e1] hover:text-black transition-colors duration-300 shadow-xl group">
              Our Story <span className="group-hover:translate-x-1 transition-transform duration-300 font-black">↗</span>
            </button>

            <button className="bg-transparent text-black px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-black hover:text-white transition-colors duration-300 border-2 border-black group">
              Our Services <span className="group-hover:translate-x-1 transition-transform duration-300 font-black">↗</span>
            </button>
          </div>
        </div>
      </div>
